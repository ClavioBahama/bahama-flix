...
const residentEvilFilmes = [
  {
    id: 1,
    title: "Resident Evil O Hospedeiro Maldito",
    image: "Acao/FT.F/Resident Evil O Hospedeiro Maldito.jpg",
    rating: 3.9,
    year: 2002,
    genre: "Ação, Terror",
    watchUrl: "Resident Evil O Hospedeiro Maldito.html",
  },
  {
    id: 2,
    title: "Resident Evil 2 Apocalipse",
    image: "Acao/FT.F/Resident Evil 2 Apocalipse.jpg",
    rating: 3.8,
    year: 2004,
    genre: "Ação, Terror",
    watchUrl: "Resident Evil 2 Apocalipse.html",
  },
  {
    id: 3,
    title: "Resident Evil 3 A Extinção",
    image: "Acao/FT.F/Resident Evil 3 A Extinção.jpg",
    rating: 3.7,
    year: 2007,
    genre: "Ação, Terror",
    watchUrl: "Resident Evil 3 A Extinção.html",
  },
  {
    id: 4,
    title: "Resident Evil 4 Recomeço",
    image: "Acao/FT.F/Resident Evil 4 Recomeço.jpg",
    rating: 3.6,
    year: 2010,
    genre: "Ação, Terror",
    watchUrl: "Resident Evil 4 Recomeço.html",
  },
  {
    id: 5,
    title: "Resident Evil 5 Retribuição",
    image: "Acao/FT.F/Resident Evil 5 Retribuição.jpg",
    rating: 3.5,
    year: 2012,
    genre: "Ação, Terror",
    watchUrl: "Resident Evil 5 Retribuição.html",
  },
]
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="flex items-center mb-6">
          ...
          <h1 className="text-3xl font-bold">Resident Evil</h1>
        </div>

        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          {residentEvilFilmes.map((filme) => (
            <Card
              key={filme.id}
