...
const narutoTemporadas = [
  {
    id: 1,
    title: "Naruto T1",
    image: "Series/FT.F/Naruto 1.jpg",
    rating: 4.2,
    year: 2002,
    genre: "Animação, Ação",
    seasons: "1 Temporada",
    watchUrl: "Naruto T1.html",
  },
  {
    id: 2,
    title: "Naruto T2",
    image: "Series/FT.F/Naruto 2.jpg",
    rating: 4.2,
    year: 2003,
    genre: "Animação, Ação",
    seasons: "1 Temporada",
    watchUrl: "Naruto T2.html",
  },
  {
    id: 3,
    title: "Naruto T3",
    image: "Series/FT.F/Naruto 3.jpg",
    rating: 4.3,
    year: 2004,
    genre: "Animação, Ação",
    seasons: "1 Temporada",
    watchUrl: "Naruto T3.html",
  },
  {
    id: 4,
    title: "Naruto T4",
    image: "Series/FT.F/Naruto 4.jpg",
    rating: 4.3,
    year: 2005,
    genre: "Animação, Ação",
    seasons: "1 Temporada",
    watchUrl: "Naruto T4.html",
  },
  {
    id: 5,
    title: "Naruto T5",
    image: "Series/FT.F/Naruto 5.jpg",
    rating: 4.4,
    year: 2006,
    genre: "Animação, Ação",
    seasons: "1 Temporada",
    watchUrl: "Naruto T5.html",
  },
  {
    id: 6,
    title: "Naruto T6",
    image: "Series/FT.F/Naruto 6.jpg",
    rating: 4.4,
    year: 2006,
    genre: "Animação, Ação",
    seasons: "1 Temporada",
    watchUrl: "Naruto T6.html",
  },
  {
    id: 7,
    title: "Naruto T7",
    image: "Series/FT.F/Naruto 7.jpg",
    rating: 4.5,
    year: 2007,
    genre: "Animação, Ação",
    seasons: "1 Temporada",
    watchUrl: "Naruto T7.html",
  },
]
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="flex items-center mb-6">
          ...
          <h1 className="text-3xl font-bold">Naruto</h1>
        </div>

        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          {narutoTemporadas.map((temporada) => (
            <Card
              key={temporada.id}
