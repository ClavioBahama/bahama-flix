...
export default function DramaPage() {
  const dramaContent = allContent.filter((item) => item.genre === "Drama")
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center gap-6">
              ...
              <Link href="/drama" className="text-red-600">
                Drama
              </Link>
            </nav>
          </div>
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="mb-6">
          <h1 className="text-3xl font-bold flex items-center mb-2">
            ...
            Filmes e Séries de Drama ({dramaContent.length})
          </h1>
          <p className="text-gray-400">Histórias emocionantes que tocam o coração!</p>
        </div>
