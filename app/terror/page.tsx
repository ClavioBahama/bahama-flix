...
export default function TerrorPage() {
  const terrorContent = allContent.filter((item) => item.genre === "Terror")
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center gap-6">
              ...
              <Link href="/terror" className="text-red-600">
                Terror
              </Link>
            </nav>
          </div>
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="mb-6">
          <h1 className="text-3xl font-bold flex items-center mb-2">
            ...
            Filmes e Séries de Terror ({terrorContent.length})
          </h1>
          <p className="text-gray-400">Prepare-se para momentos de puro terror!</p>
        </div>

        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
          {terrorContent.map((item) => (
