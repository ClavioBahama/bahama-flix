...
const soldadoAnonimoFilmes = [
  {
    id: 1,
    title: "Soldado Anônimo",
    image: "Acao/FT.F/Soldado Anônimo.jpg",
    rating: 4.1,
    year: 2005,
    genre: "Guerra, Drama",
    watchUrl: "Soldado Anônimo 1.html",
  },
  {
    id: 2,
    title: "Soldado Anônimo 2 Campo em Chamas",
    image: "Acao/FT.F/Soldado Anônimo 2 Campo em Chamas.jpg",
    rating: 3.9,
    year: 2014,
    genre: "Guerra, Drama",
    watchUrl: "Soldado Anônimo 2 Campo em Chamas.html",
  },
  {
    id: 3,
    title: "Soldado Anônimo 3",
    image: "Acao/FT.F/Soldado Anônimo 3.jpg",
    rating: 3.8,
    year: 2015,
    genre: "Guerra, Drama",
    watchUrl: "Soldado Anônimo 3.html",
  },
]

export default function SoldadoAnonimoPage() {
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="flex items-center mb-6">
          ...
          <h1 className="text-3xl font-bold">Soldado Anônimo</h1>
        </div>

        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          {soldadoAnonimoFilmes.map((filme) => (
            <Card
              key={filme.id}
