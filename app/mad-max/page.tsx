...
const madMaxFilmes = [
  {
    id: 1,
    title: "Mad Max",
    image: "Acao/FT.F/Mad Max.jpg",
    rating: 4.0,
    year: 1979,
    genre: "Ação, Ficção Científica",
    watchUrl: "Mad Max (1).html",
  },
  {
    id: 2,
    title: "Mad Max 2 A Caçada Continua",
    image: "Acao/FT.F/Mad Max 2 A Caçada Continua.jpg",
    rating: 4.1,
    year: 1981,
    genre: "Ação, Ficção Científica",
    watchUrl: "Mad Max 2 A Caçada Continua.html",
  },
  {
    id: 3,
    title: "Mad Max 3 Além da Cúpula do Trovão",
    image: "Acao/FT.F/Mad Max 3 Além da Cúpula do Trovão.jpg",
    rating: 3.8,
    year: 1985,
    genre: "Ação, Ficção Científica",
    watchUrl: "Mad Max 3 Além da Cúpula do Trovão.html",
  },
  {
    id: 4,
    title: "Mad Max Estrada da Fúria",
    image: "Acao/FT.F/Mad Max Estrada da Fúria.jpg",
    rating: 4.5,
    year: 2015,
    genre: "Ação, Ficção Científica",
    watchUrl: "Mad Max Estrada da Fúria.html",
  },
]
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="flex items-center mb-6">
          ...
          <h1 className="text-3xl font-bold">Mad Max</h1>
        </div>

        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          {madMaxFilmes.map((filme) => (
            <Card
              key={filme.id}
